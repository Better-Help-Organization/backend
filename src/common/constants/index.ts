...
export const SessionNotif: Record<string, { code: string; title: string; showNotification: boolean }> = {
  SCHEDULED: { code: "1", title: "📅 Woohoo! Session scheduled", showNotification: true, },
  NEW_MESSAGE: { code: "2", title: "💬 You’ve got mail (well…a message 😄)", showNotification: true, },
  EDIT_MESSAGE: { code: "3", title: "✏️ Message updated", showNotification: true, },
  MESSAGE_READ: { code: "4", title: "👀 Message read", showNotification: false, },
  INCOMING_CALL: { code: "5", title: "📞 Ring ring! Someone’s calling", showNotification: true, },
  CALL_ENDED: { code: "6", title: "📴 Call ended", showNotification: true, },
  CALL_REJECTED: { code: "7", title: "🚫 Call rejected", showNotification: true, },
  CHAT: { code: "8", title: "💬 You’ve been added to a chat", showNotification: false, },
